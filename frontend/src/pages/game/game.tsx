    ...
    <div>
        ...
        <div className = "gameContainer">
          ...
          <div className="centerBoard">
            <GameRow isCorrect={false} exists={true} letterArray={gameRow} rowIndex={1}></GameRow>
            <GameRow isCorrect={false} exists={true} letterArray={gameRow} rowIndex={2}></GameRow>
            <GameRow isCorrect={false} exists={true} letterArray={gameRow} rowIndex={3}></GameRow>
            <GameRow isCorrect={false} exists={true} letterArray={gameRow} rowIndex={4}></GameRow>
            <GameRow isCorrect={false} exists={true} letterArray={gameRow} rowIndex={5}></GameRow>
          </div>
